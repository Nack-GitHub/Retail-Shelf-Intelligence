...
- [ ] **Task 3: `useCamera` — callback ref + generation token**
  - Acceptance:
...
- [ ] **Task 4: `useCamera` — ฟื้นตัวเองเมื่อ track ตาย + `grab()` รอ metadata**
  - Acceptance:
...
- [ ] **Task 8: flow step graph + `useFlow()` + `FlowGuardBlock`**
  - Acceptance:
...
- [ ] **Task 9: ย้ายหน้าต้นทางมาใช้ `useFlow`**
...
- [ ] **Task 10: ย้ายหน้าปลายทางมาใช้ `useFlow`**
...
- [ ] **Task 11: `MobileHeader` back ของ flow + ทิศ animation จาก step**
