...
make dataset        # แตกไฟล์ dataset (1,349 ภาพ) — ข้ามได้ถ้าไม่เทรนโมเดล
make infra          # postgres + redis + minio
make migrate seed   # สร้าง schema + ข้อมูลตั้งต้น
...
หลังรีเซ็ตแล้วสั่ง `make demo` หนึ่งครั้ง จะได้ชุดข้อมูลที่เล่าเรื่องได้:
ร้านที่ยังไม่เคยเข้า 4 ร้านขึ้นเป็น "เสี่ยงสูง" พร้อมข้อความ "ยังไม่เคยตรวจ"
และร้านที่เพิ่งตรวจ 1 ร้านแสดง OSA จริง
